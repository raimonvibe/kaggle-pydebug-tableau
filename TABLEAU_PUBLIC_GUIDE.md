...
If Tableau Public is slow, start with sample data:
...
1. Open Tableau Public -> **Text file**
...
## Dashboard 3: Response vs Rejected Length
- **Columns**: `AVG([Rejected_Words])`
- **Rows**: `AVG([Response_Words])`
- **Detail**: `Category`
...
- **Label**: `COUNT([Instruction])`

Use this to identify categories with richer final responses.

## 5) Interactivity that makes dashboards better
...
## 6) Data storytelling tips for Tableau Public
...
- Use dashboard size **Automatic** or a common web size (e.g., 1200x800)
...
- **Sheet 4**: Response vs Rejected Length
